...
<bbNG:learningSystemPage>
    <bbData:context id="ctx">
            ...
            <SCRIPT type="text/javascript">
	            ...
	            function save() {
	            	if(validTelephone()){
		                ...
		                window.location.href = "${pageContext.request.contextPath}/userPhone/updatePhoneNum.do?newPhoneNum="+telephone
		                		+"&course_id="+course_id
		                		+"&type="+typeName
		                		+"&validNum="+validNum;
	            	}
        ...
        <bbNG:pageHeader instructions="更换手机号,推荐使用Firefox或Chrome浏览器，不建议使用IE浏览器">
            <c:if test="${type == 'meetingroom'}">
        ...
        <bbNG:actionControlBar>
            <bbNG:actionPanelButton type="SEARCH" alwaysOpen="true">
                <bbNG:form id="searchForm" name="searchForm" action="" method="POST">
				    <c:if test="${tips != null }">
                		<span style="font-size:15px;font-color:blue;">${tips}</span> <br/><br/>
                	</c:if>       
				           用户名：<input type="text" name="user_id" disabled="disabled" value="${userPhone.userId}" id="user_id"><br/>
				           请输入手机号：<input type="text" name="telephone" value="${userPhone.phone}" id="telephone"><br/>
				   	 请确认手机号：<input type="text" name="confirmTelephone" value="${confirmTelephone}" id="confirmTelephone"><br/>
                    ...
                    <input type="button" name="btn" value="确定修改" onclick="save()">
                    <br/><br/>
                    	<span style="font-size:15px;">手机号格式为：00国家号-手机号；注意：中国大陆手机号不写国家号。</span><br/>
                    	<span style="font-size:15px;">例如：例如：美国手机号 1 (800) 643-7676 填成 001-8006437676；中国大陆手机号填成 15800000001</span>
                </bbNG:form>
