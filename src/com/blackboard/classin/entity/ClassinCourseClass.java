...
public class ClassinCourseClass {
    ...
    public String getClassTotalTime() {
        return classTotalTime;
    }

    public void setClassTotalTime(String classTotalTime) {
        this.classTotalTime = classTotalTime;
    }
    ...
    public void setAssistantTeacherName(String assistantTeacher) {
        this.assistantTeacherName = assistantTeacher;
    }
	...
	public void setCloseClassDelay(int closeClassDelay) {
		this.closeClassDelay = closeClassDelay;
	}
